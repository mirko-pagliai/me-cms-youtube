...
class VideosWidgetsCellTest extends TestCase
{
    ...
    public function testCategories()
    {
        ...
        $widget->request->withEnv('REQUEST_URI', Router::url(['_name' => 'videosCategories']));
    ...
    public function testLatest()
    {
        ...
        $widget = $this->Widget->widget($widget);
        $widget->request->withEnv('REQUEST_URI', Router::url(['_name' => 'videos']));
        $this->assertEmpty($widget->render());
    ...
    public function testSearch()
    {
        ...
        //Empty on search
        $widget = $this->Widget->widget($widget);
        $widget->request->withEnv('REQUEST_URI', Router::url(['_name' => 'videosSearch']));
        $this->assertEmpty($widget->render());
    }
}
